...
<div class="card" style="margin-bottom:20px;">
    ...
    <table class="data-table">
        ...
        <tr>
            <td><span class="badge {{ $filter->type === 'email' ? 'badge-pending' : 'badge-open' }}">{{ $filter->type === 'email' ? __('admin.ticket_spam.email_pattern') : __('admin.ticket_spam.keyword') }}</span></td>
