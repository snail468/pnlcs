...
<tr><td style="padding:8px;border-bottom:1px solid #eee;"><strong>{{ __('email.affiliate_welcome.commission_type') }}</strong></td><td style="padding:8px;border-bottom:1px solid #eee;">{{ ($affiliate->pay_type ?? 'percentage') === 'percentage' ? __('admin.affiliates.pay_percentage') : __('admin.affiliates.pay_fixed') }}</td></tr>
</table>
