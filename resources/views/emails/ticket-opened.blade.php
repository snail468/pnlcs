...
<tr><td style="padding:8px;border-bottom:1px solid #eee;"><strong>{{ __('email.common.priority_label') }}</strong></td><td style="padding:8px;border-bottom:1px solid #eee;">{{ __('common.priority.' . strtolower($ticket->priority ?? 'medium')) }}</td></tr>
</table>
